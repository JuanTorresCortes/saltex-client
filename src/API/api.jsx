...
//       stage: "initiation, planning, execution, monitor & Control, closeout",
//       tasks: [
//         {
//           id: 1,
//           owner: "initiation",
...
//       percent: 25,
//       startDate: "2023-01-01",
//       estimateCompletionDate: "2023-01-01",
//       endDate: "2023-01-01",
//     },
//     {
//       id: 2,
  ...
  return [
    {
      ...
      tasks: [
        {
          ...
          description: "Description of Initiation Task",
          crewID: ["1", "2"],
          status: "Completed",
          startDate: "2023-01-01",
          endDate: "2023-01-02",
        },
        {
          ...
          owner: "planning",
          name: "Planning Task",
          description: "Description of Planning Task",
          crewID: ["1", "2", "3"],
          status: "Completed",
        ...
        },
        {
          ...
          owner: "execution",
          name: "Execution Task",
          description: "Description of Execution Task",
          crewID: ["2", "3"],
          status: "In progress",
        ...
        {
          id: 4,
          owner: "monitor & control",
          name: "Monitor & Control Task",
          description: "Description of Monitor & Control Task",
          crewID: ["1", "3"],
          status: "Pending",
        ...
        },
        {
          ...
          owner: "closeout",
          name: "Closeout Task",
          description: "Description of Closeout Task",
          crewID: ["1"],
          status: "Pending",
      ...
      percent: 25,
      startDate: "2023-01-01",
      estimateCompletionDate: "2023-01-10",
      endDate: "2023-01-10",
    },
    {
      id: 2,
      ...
      percent: 50,
      startDate: "2023-02-01",
      estimateCompletionDate: "2023-02-10",
      endDate: "2023-02-10",
    },
    {
      id: 3,
      ...
      percent: 100,
      startDate: "2023-03-01",
      estimateCompletionDate: "2023-03-10",
      endDate: "2023-03-10",
    },
  ];
};
