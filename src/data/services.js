...
//     title: "CONSULTATION",
//     description:
//       "Our construction services are designed to create beautiful and functional homes that enhance the quality of life for families. We work closely with clients to understand their unique needs and design custom solutions that meet their specific requirements. Our team of experienced architects and engineers work closely with clients to ensure that every project is designed and built to the highest standards. Our services include everything from design and planning to construction and maintenance. Our commitment to quality and precision ensures that every home we build is a masterpiece that reflects the client’s unique vision.",
